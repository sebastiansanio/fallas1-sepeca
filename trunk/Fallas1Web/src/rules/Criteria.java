...
public class Criteria {
	...
	public Criteria(){
		...
		attribute=new Attribute("DistanciaFinesDeSemana","¿Que distancia recorre los fines de semana?","3.1",2,"Uso",2);
		attribute.addOptions("NS/NC","0 a 50 km","50 a 200 km","Más de 200 km");
		attributeList.add(attribute);
		
		attribute=new Attribute("CantVacaciones","¿Cuantas veces al año viaja?","3.1",2,"Uso",3);
		attribute.addOptions("NS/NC","1 vez","2 veces","Más de 2 veces");
		attributeList.add(attribute);

		attribute=new Attribute("KmViaje1","En promedio, ¿Cuantos kilometros realiza por cada viaje?","3.1.1",3,"CantVacaciones",1);
		...
		attribute=new Attribute("KmViaje3","En promedio, ¿Cuantos kilómetros anuales realiza?","3.1.1",3,"CantVacaciones",3);
